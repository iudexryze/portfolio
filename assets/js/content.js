...
{ id:'arcade', title:'ARCADE', gloss:'eight games, six on this screen', items:[
  { id:'bt-7274n', name:'BT-7274N', tag:'Terminal roguelike',
    ...
    props:[['INPUT','Typed. Wants a real keyboard.'],['RUNS','Full screen. Twelve typed commands is not a thing a D-pad can do.'],['BUILD','One HTML file, no dependencies']],
    actions:[{label:'PLAY', launch:'bt-7274n'},{label:'SOURCE', href:'https://github.com/iudexryze/portfolio/tree/main/play/bt-7274n'}] },
  { id:'drift-lander', name:'Drift Lander', tag:'Physics arcade',
    ...
    props:[['INPUT','D-pad. Left and right rotate, up is thrust.'],['RUNS','On this screen']],
  ...
  { id:'circuit-breaker', name:'Circuit Breaker', tag:'Routing puzzle',
    ...
    props:[['INPUT','D-pad picks a cell, A rotates it, B reverses.'],['RUNS','On this screen']],
  ...
  { id:'overclock', name:'Overclock', tag:'Arena dodger',
    ...
    props:[['INPUT','Touch or keyboard'],['RUNS','Full screen. It wants an axis held finer than four directions can hold it.']],
  ...
  { id:'disco-race', name:'Disco Race', tag:'Rhythm racer',
    ...
    props:[['INPUT','Left and right steer, down brakes, A taps the beat.'],['RUNS','On this screen'],['TEMPO','124 BPM']],
  ...
  { id:'refactor', name:'Refactor', tag:'Graph puzzle',
    ...
    props:[['INPUT','The D-pad aims a crosshair, A picks a node up and puts it down.'],['RUNS','On this screen']],
  ...
  { id:'heap', name:'Heap', tag:'Precision stacker',
    ...
    props:[['INPUT','A drops the block. That is the whole game.'],['RUNS','On this screen']],
  ...
  { id:'mutex', name:'Mutex', tag:'Timing game',
    ...
    props:[['INPUT','The D-pad aims a crosshair, A grabs a runner.'],['RUNS','On this screen']],
